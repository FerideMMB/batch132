...
public class Varargs01 {
    ...
    2)"Varargs" is a data structure uses "Arrays" behind that is why when you use "Varargs" you may think
    you are using "Arrays"
    3)Question: Can I use more than one "Varargs" in a method?
                ...
                so second parameter will be "unreachable".If you type "unreachable code" in anywhere in Java will
                give you error.
     ...
     5)Question:Can I use parameter before "Varargs" in a method?
                 Yes , I can . Using parameters before "Varargs" is possible.
     6)"Varargs" can be declared like "int... v"    or "int ...v". There is no any other usage
    ...
    public static int addTwoInt(int a, int b,int c, int d) {
        return a + b + c + d;
    }
