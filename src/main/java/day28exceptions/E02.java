...
public class E02 {
    public static void main(String[] args) {
       // printAge(-23);
        ...
        ///         If the age is negative the age should not put on the console
       ...
       //         If the grade is less than zero or greater than 100, the method should throw Exception with a message
        public static void  studentsGrade(int grade) {
            if (grade<0 ){
                throw  new IllegalArgumentException("Grade cannot be less than zero "+ grade);
            } else if (grade>100) {
                throw  new IllegalArgumentException("Grade cannot be greater than 100 " +grade);
            }
