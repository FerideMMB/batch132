...
public class StaticBlock01 {
    ...
    3)To initialize "static variables" we have two options
       i)initialize directly  "public static int price=1000;"
      ...
      Instance Block is used if you want to execute same code in all constructor
   ...
   static {
    ...
    public int year;
    {
        System.out.println("I am instance bblock");
    }
