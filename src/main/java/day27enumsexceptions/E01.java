...
public class E01 {
    ...
    2)When we have Exception we have two ways
        i)We can handle  teh Exception by using "try-catch block"
    ...
    public static void main(String[] args) {
        System.out.println(divide1(6, 5));//1
        System.out.println(divide1(0, 5));//0
        ...
        System.out.println("Hi this is me!");//divide(6,0) threw ArithmeticException that is why this code cannot be executed
                                             //When you break any matematical
    ...
    public static int divide2(int a , int b){
        ...
        }catch(ArithmeticException e){//"catch block" executed just for Exceptions, if "try block" does not throw
            // any Exception "catch block" will not be executed
