...
5)To be able to execute "Constructor"  from top to bottom , Java goes to the "Object Class" first
by  the help of the "super()" code.
...
12)"this()" and "super()" cannot be used in the same constructor together, because if you put anyone into the first
line the other cannot be put into the first line.
...
Answer: "super()" is for calling constructor from the first level parent class
         ...
         4)Abstraction = Abstraction Class(NOt OK) + Interface(Not OK)
 */
