...
public class Student {
    /*
       ...
       ii)"Return Type" must be same with the "DataType" of the variable
       ...
       4)After encapsulating a data , if you  need you may "update" the valur by using "set method"(setter)
       5)In setters;
       i)"Access Modifier" is "public"
