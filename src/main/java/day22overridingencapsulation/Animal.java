...
public class Animal {
    /*
    1)Sometime using method directly from parents class may not be enough for us.
     ...
     3)The method in child class (Overriding Method )cans use "same" or "wider" access modifier than the method in
     parent class (Overridden Method)
     4)When you change the return type in "Method Overriding, from child to parent you must hav "IS-A" relationship
     5)Return Type of the Overridden Method  can be the "top return type" of the Overriding Method
     6)IF there is "IS-A" relationship between return types, those called "Covariant Return Type"
     ...
     8)Between the "primitive data types "there is no "parent -child relationship" that is why you cannot have
     "IS-A" relationship
     If you do not have "IS-A" relationship you cannot change return type in "Method Overriding"
     ...
     If you use "final" keyword for variables:i) You have to initialize the variable ii) After assigning a value you cannot
     update the value.
     2)"final" keyword can be used for classes(we cannot change because it cannot have a child classes)
     IF you use "final " keyword for a  class , the class cannot have "Child Class"
     3)"final" keyword can be used for  methods, the method cannot be overridden.
     ...
     iii)We do not touch "method signature" in "Method Overriding"  but we change "parameters" I mean method signature
     in "Method Overloading"
     iv)We cannot override "static" methods but we can "overload" them
     v)Other name of "Method Overloading " is a "Static  Polymorphism"
       Other name of "Method Overriding " is a "Dynamic Polymorphism"
     vi)Other name of "Method Overloading " is a "Compile Time  Polymorphism"
       Other name of "Method Overriding" is a "Run Time  Polymorphism"
     */
