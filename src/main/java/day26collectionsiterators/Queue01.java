...
public class Queue01 {
    public static void main(String[] args) {
        ...
        que. add("Brad");
        que. add("Jim");
        System.out.println(que);//[Tom, Ajda, Brad, Jim]==> Elements are in "insertion order" because I used LinkedList
       //                                                                                      as constructor
        ...
        System.out.println(dq);//[Tom, Ajda, Brad, Jim]
                              //If you look at the Deque methods, you will notice the methods are in... first()  and
        //                      ..last(). The methods are focusing first and the last elements
