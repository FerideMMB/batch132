...
public class Iterators01 {
    public static void main(String[] args) {
        ...
        2)Loops have infinitive loop risk but Iterators do not have
        ...
        5)There are two type of iterators:i)Iterator:It can just remove the elements, it is impossible to update.
        ...
        //Example: Print the yourList elements on the console from the last element to the first element in the same line with a space
