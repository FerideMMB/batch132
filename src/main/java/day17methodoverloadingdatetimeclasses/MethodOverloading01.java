...
public class MethodOverloading01 {
    /*
   1) If you create methods with i)the same name and  ii)different parameter, it means you created "method overloading"
   ...
   5)Access modifiers do not take any role in "method overloading" that is why methods in any access modifier can
       be overloaded
       6) To be static or non -static does not affect "method overloading" that is why static and non-static methods can
       be overloaded
     */
