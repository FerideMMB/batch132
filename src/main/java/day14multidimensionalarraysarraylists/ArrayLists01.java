...
public class ArrayLists01 {
        ...
        we may need more elements to store or fewer elements to store  inside the array.
        ...
        public static void main(String[] args) {
            ...
            //Hot to add elements into an ArrayList?
           ...
           // ages.addAll(prices); adds "prices" list elements into the " ages" list element
            ...
            //How to check if a specific element or element exist in a list
           boolean r1= ages.contains(44);
            System.out.println(r1); // true

            //ages.containsAll(prices); if all prices list elements exist in ages list, Java returns true otherwise
           // returns false
