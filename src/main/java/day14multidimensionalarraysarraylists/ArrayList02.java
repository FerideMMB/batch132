...
public class ArrayList02 {
    ...
    When you talk about "Lists" use "Lists size"
     */
    public static void main(String[] args) {
        //Example 1: Type code to print the elements of a list if the elements is greater than the number of elements
        //             in the list
        //     [5, 9, 3, 4, 6] ==> 9 - 6
