...
public class Sets01 {
    public static void main(String[] args) {
        ...
        There are 3 sets:i)HashSet :Uses hashing technique.
                                    ...
                                    HashSet allows you to store "null" as value
                         ii)LinkedHashset:LinkedHAshSet puts the elements in "insertion order"
                                          that is why it is slower than HashSet
                         iii)TreeSet:TreeSet puts the element in natural order needs too much time
        ...
        hs.add(45);
        hs.add(19);
        hs.add(14);//When you add same element repeatedly , Java does not give error. It puts the repeated element just
        //once into the set.
        hs.add(null);
        hs.add(null);
       ...
       boolean r1= lhs.retainAll(myLhs);//retainAll() method does not touch myLhs which is the method inside the parenthesis
        ...
        System.out.println(myLhs);//[12, 30, 14, 50, 32]
        /*
        You have products set, you have discounted product set
        You want to see discounted product in the all products set
      ...
      Interview Question: What do you use to store unique elements in natural order?
                   ...
                   But as you know TreeSet are so slow , how  can you prevent your code works slowly?
        ...
        */
        ...
        System.out.println(ts1);//[abc@gmail.com, acd@gmail.com, bcm@gmail.com, caf@gmail.com, chi@gmail.com]
        ...
        System.out.println(ts2);//[abc@gmail.com, acd@gmail.com, bcm@gmail.com, caf@gmail.com, chi@gmail.com]
