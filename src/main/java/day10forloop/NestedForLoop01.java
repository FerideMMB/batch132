...
public class NestedForLoop01 {
    public static void main(String[] args) {
        ...
        There is a way to calculate teh value of "time complexity":
               - if you have 2 loops, the time complexity is the square od 2==>4;
               - if you have 3 loops,the time complexity is the cube of 3 ==>7
         */
        for(int i=1;i<5;i++){
 ...
 */
        ...
        for(int i=1; i<rows; i++){
            ...
            System.out.println("");// the empty function of "sout" it means to take pointer to  the new line
                                   // when you finish with the inner loop
        }
    }
}
