...
public class StringManipulations02 {
    public static void main(String[] args) {
        ...
        //2.Way : Recommended  (is better) because if Java has a method for a specific task we always prefer to use it
        boolean r2 =s.isEmpty();
        System.out.println("Is the given String empty?" + r2);

        //Example 2 : Type code to check if the given String is containing just "space character" or not
        //            "       " ==>true  - "a    b  " ==>false
        String t = "    ";
