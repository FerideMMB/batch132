...
/*
   ...
   4)When you create an "Abstract method"s the functionality will be mandatory for the child classes
   5)If the functionality is not mandatory do not make it abstract make it concrete
   6)To make a method abstract
     i)Remove method body
     ii)Use abstract keyword between "access modifier" and "return type"
     iii)Change teh "concrete class" to "abstract class" by using abstract keyword between "access modifier" and "class"keyword
   ...
   9)"final" methods must have "constant method body" but in abstraction every child class will use the "abstract method"
   ...
   10)An "abstract class" cannot be "final"because "final" class cannot have "child classes" but abstract class
      should have child classes to make "abstract method"s to be implemented in child classes
   11)"abstract classes"es can have "abstract methods","abstract methods" are "uncompleted methods" because they do not have body part.
      If you create and object from an "abstract class" the object will have missing parts.
    ...
    13)We create "abstract method" for the child classes to use, but if you mak the access modifier "private" it means
    ...
    15)Some rule in Overriding are valid for implementing abstract methods.
