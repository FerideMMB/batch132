...
public class AnimalRunner {
    public static void main(String[] args) {
        ...
        System.out.println(myCat.age);//14<== Cat CLass had "age" variable , that is why the object does not
                                      //     use the variable from the parent
        //When you create and object you can select data type of the object from the class itself or
        // from any parent
        Object cat0=new Cat();
